...
<div class="modal fade" id="modal-edit{{ $data->id }}">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <form action="/masterdata/merkhw/updatemerkhw/{{ $data->id }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="modal-body">            
            <div class="form-group">
                <label>Nama Merk Hardware</label>                                
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="/masterdata/merkhw/deletemerkhw/{{ $data->id }}" class="btn btn-danger">Ya</a>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
